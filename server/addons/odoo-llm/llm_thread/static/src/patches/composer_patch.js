...
patch(Composer.prototype, {
  ...
  async sendMessage() {
    if (this.isLLMThread && this.llmStore) {
      const content = (this.props.composer.composerText || this.props.composer.text || "").trim();
  ...
  get isDisabled() {
    if (this.isLLMThread) {
      return this.isStreaming || !(this.props.composer.composerText || this.props.composer.text || "").trim();
    }
